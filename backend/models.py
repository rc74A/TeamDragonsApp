...
class Job(Base):
    ...
    prep_notes: Mapped[str | None] = mapped_column(Text, nullable=True, default="")
    notes_updated_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True, default=utc_now)
