import { LoaderFunction, LoaderFunctionArgs, UNSAFE_DataWithResponseInit } from "react-router";
import { Organization, Session, User, VerifyTokenOptions } from "@clerk/backend";
import { OrganizationSyncOptions, RequestState, SignedInAuthObject, SignedOutAuthObject } from "@clerk/backend/internal";
import { MultiDomainAndOrProxy, SignInFallbackRedirectUrl, SignInForceRedirectUrl, SignUpFallbackRedirectUrl, SignUpForceRedirectUrl } from "@clerk/shared/types";
...
interface KeylessUrls {
  __keylessClaimUrl?: string;
  __keylessApiKeysUrl?: string;
}
type AdditionalStateOptions = SignInFallbackRedirectUrl & SignUpFallbackRedirectUrl & SignInForceRedirectUrl & SignUpForceRedirectUrl & KeylessUrls;
/**
 * @deprecated This type is no longer used internally. Use `AdditionalStateOptions` instead.
 */
type RequestStateWithRedirectUrls = RequestState & SignInForceRedirectUrl & SignInFallbackRedirectUrl & SignUpForceRedirectUrl & SignUpFallbackRedirectUrl & KeylessUrls;
...
//#endregion
export { LoaderFunctionArgsWithAuth as a, RequestWithAuth as c, KeylessUrls as i, RootAuthLoaderCallback as l, ClerkMiddlewareOptions as n, LoaderFunctionReturn as o, GetAuthReturn as r, RequestStateWithRedirectUrls as s, AdditionalStateOptions as t, RootAuthLoaderOptions as u };
//# sourceMappingURL=types-CkBFvMvW.d.ts.map